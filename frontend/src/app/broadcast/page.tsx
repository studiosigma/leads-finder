...
import { Megaphone, MessageCircle, Mail, Send, CheckCircle2, Users, Tag, Sparkles, Loader2, Play, Pause, ShieldCheck, AlertCircle } from 'lucide-react';

const DEFAULT_LEADS = [
  { id: '1', name: 'Rumah Sakit Mitra Plumbon Cibitung', category: 'Rumah Sakit', location: 'Cibitung, Bekasi', website: 'mitraplumboncibitung.com', email: 'info@mitraplumboncibitung.com', phone: '+62 812-1817-2918', whatsapp_url: 'https://wa.me/6281218172918' },
  { id: '2', name: 'Acme Corp Technology', category: 'Technology', location: 'San Francisco, CA', website: 'acme.co', email: 'sarah@acme.co', phone: '+1 555-0192', whatsapp_url: 'https://wa.me/15550192' },
  { id: '3', name: 'Data Tech Solutions', category: 'Data & Analytics', location: 'San Francisco, CA', website: 'datatech.io', email: 'contact@datatech.io', phone: '+1 555-0192', whatsapp_url: 'https://wa.me/15550192' },
  { id: '4', name: 'Global Marketing Solutions', category: 'Marketing', location: 'Jakarta Selatan', website: 'globalsol.com', email: 'info@globalsol.com', phone: '+62 813-8822-1990', whatsapp_url: 'https://wa.me/6281388221990' },
];
...
export default function BroadcastPage() {
  ...
  useEffect(() => {
    async function fetchLeads() {
      try {
        ...
        console.error('Using default broadcast leads fallback:', err);
      }
    }
    fetchLeads();
  }, []);
  ...
  const sampleLead = targetLeads[0] || DEFAULT_LEADS[0];
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200/90 shadow-xs space-y-4">
            ...
            <div className="p-4 bg-slate-50 border border-slate-200/80 rounded-xl space-y-2 text-xs font-sans text-slate-800 whitespace-pre-wrap leading-relaxed">
              <div className="text-[11px] font-bold text-slate-500 border-b border-slate-200 pb-1 mb-2">
                Recipient: {sampleLead?.name} ({sampleLead?.category} - {sampleLead?.location})
              </div>
