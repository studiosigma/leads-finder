...
export const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <div className={`flex mb-6 px-1 transition-all ${isCollapsed ? 'flex-col items-center gap-3' : 'items-center justify-between'}`}>
        <Link href="/" className="flex items-center gap-3 group overflow-hidden">
          <div className="w-9 h-9 rounded-2xl bg-white p-1 border border-slate-200/90 shadow-xs flex items-center justify-center overflow-hidden shrink-0 group-hover:scale-105 transition-transform">
            <img
              src="/logo.png"
              alt="LFE Brand Logo"
        ...
        <button
          ...
          className="p-1.5 text-slate-400 hover:text-slate-700 hover:bg-slate-200/60 rounded-xl transition-colors shrink-0 flex items-center justify-center"
